...
urlpatterns = i18n_patterns("",
                            ...
                            url(r'^customers/detail/(?P<pk>\d+)/$', views.ViewCustomer.as_view(),
                                name='customer_detail'),
                            url(r'^customers/create/$', views.CreateCustomer.as_view(), name='customer_create'),
                            url(r'^customers/createcontract/(?P<customer_pk>\d+)/$',
                                views.create_contract_from_customer,
                                name='customer_create_contract'),
                            url(r'^customers/edit/(?P<pk>\d+)/$', views.EditCustomer.as_view(), name='customer_edit'),
                            url(r'^customers/delete/(?P<pk>\d+)/$', views.DeleteCustomer.as_view(),
                            ...
                            url(r'^suppliers/detail/(?P<pk>\d+)/$', views.ViewSupplier.as_view(),
                            ...
                            url(r'^suppliers/delete/(?P<pk>\d+)/$', views.DeleteSupplier.as_view(),
                            ...
                            url(r'^productcategory/create/$', views.CreateProductCategory.as_view(),
                                name='productcategory_create'),
                            url(r'^productcategory/edit/(?P<pk>\d+)/$', views.EditProductCategory.as_view(),
                            ...
                            url(r'^products/delete/(?P<pk>\d+)/$', views.DeleteProduct.as_view(),
                                name='product_delete'),
                            ...
                            url(r'^billingcycles/create/$', views.CreateBillingCycle.as_view(),
                                name='customerbillingcycle_create'),
                            url(r'^billingcycles/edit/(?P<pk>\d+)/$', views.EditBillingCycle.as_view(),
                            ...
                            url(r'^purchaseorders/edit/(?P<pk>\d+)/$', views.EditPurchaseOrder.as_view(),
                                name='purchaseorder_edit'),
                            url(r'^purchaseorders/delete/(?P<pk>\d+)/$', views.DeletePurchaseOrder.as_view(),
                                name='purchaseorder_delete'),
                            url(r'^purchaseorders/detail/(?P<pk>\d+)/$', views.view_purchaseorder_details,
                            ...
                            url(r'^customergroups/create/$', views.CreateCustomerGroup.as_view(),
                                name='customergroup_create'),
                            url(r'^customergroups/edit/(?P<pk>\d+)/$', views.EditCustomerGroup.as_view(),
                                name='customergroup_edit'),
                            url(r'^customergroups/delete/(?P<pk>\d+)/$', views.DeleteCustomerGroup.as_view(),
                            ...
                            url(r'^contracts/detail/(?P<pk>\d+)/$', views.ViewContract.as_view(),
                            ...
                            url(r'^invoices/delete/(?P<pk>\d+)/$', views.DeleteInvoice.as_view(),
                                name='invoice_delete'),
